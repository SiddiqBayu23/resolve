                ...
                <div className="about__values__box flex flex-col items-center gap-6 mt-20">
                    <div className='flex items-center gap-12 w-1/2'>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <p className='about__text font-manrope text-light'>SkinAesth membantu Anda merawat kulit dengan panduan produk skincare sesuai jenis kulit Anda. Kami menyediakan informasi merek dan produk sesuai kebutuhan.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center gap-12 w-1/2'>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <p className='about__text font-manrope text-light'>SkinAesth menyajikan berbagai kategori skincare untuk memenuhi kebutuhan kulit Anda, mulai dari cleanser hingga sunscreen. Kami menyediakan informasi tentang produk sesuai jenis Kulit untuk membantu Anda menemukan yang terbaik di setiap kategori.</p>
                        </div>
                    </div>
                    <hr className='border-[05.px] border-gray-400 w-1/2 my-4' />
                    <div className='flex items-center gap-12 w-1/2'>
                    ...
                    <div className='flex items-center gap-12 w-1/2'>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <p className='about__text font-manrope text-light'>Melalui forum diskusi SkinAesth, Anda dapat aktif berpartisipasi, mengajukan pertanyaan, serta berbagi pengalaman pribadi Anda seputar skincare. </p>
                        </div>
                    </div>
                </div>
            </div>
