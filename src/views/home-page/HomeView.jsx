...
import HomeHeader1 from '/assets/images/home-header.png';
import HomeHeader2 from '/assets/images/header-2.png';
import HomeHeader3 from '/assets/images/header-3.png';
...
const HomeView = ({ categories, best, handleNavigateDetail, blogs, handleNavigateBlog, carouselSettings }) => (
  <div className="home">
    ...
    <header>
      <Slider {...carouselSettings}>
        <div className='relative'>
          <img src={HomeHeader1} alt="Home Header Image" className='home_header_image' />
        </div>
        <div className='relative'>
          <img src={HomeHeader3} alt="Home Header Image" className='home_header_image' />
          <div className='absolute top-[30rem] left-[30rem]'>
            <a href='/blog' className='px-4 py-4 rounded-sm bg-[#333232] text-white text-sm'>BACA SELENGKAPNYA</a>
          </div>
        </div>
        <div className='relative'>
          <img src={HomeHeader2} alt="Home Header Image" className='home_header_image' />
          <div className='absolute top-[30rem] left-[32rem]'>
            <a href='/blog' className='px-4 py-4 rounded-sm bg-[#79B7B9] text-white text-sm'>CARI TAU LEBIH LANJUT</a>
          </div>
        </div>
      </Slider>
    </header>
